...
public class StudentDao extends AbstractDao<Student, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Banji = new Property(4, String.class, "banji", false, "BANJI");
    }
    ...
    public Student readEntity(Cursor cursor, int offset) {
        Student entity = new Student( //
            ...
            cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4) // banji
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Student entity, int offset) {
        ...
        entity.setBanji(cursor.isNull(offset + 4) ? null : cursor.getString(offset + 4));
     }
